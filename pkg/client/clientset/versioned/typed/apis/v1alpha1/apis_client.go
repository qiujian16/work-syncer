...
import (
	...
	"github.com/qiujian16/work-syncer/pkg/client/clientset/versioned/scheme"
...
func (c *WorkV1alpha1Client) StatusSyncs(namespace string) StatusSyncInterface {
	return newStatusSyncs(c, namespace)
}
